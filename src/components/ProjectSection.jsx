                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      {project.liveUrl && (
                        <a
                          ...
                          className="px-2.5 py-1 rounded-lg bg-gold-500 hover:bg-gold-400 text-dark-900 font-extrabold text-[11px] flex items-center gap-1 shadow-md transition-all"
                          title="Open Live Application"
                        >
                          <span>Live</span>
                          <ExternalLink className="w-3 h-3 text-dark-900" />
                        </a>
                      )}
                      <a
                  ...
                  <div className="flex items-center gap-2">
                    {project.liveUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 py-2.5 px-3 rounded-xl bg-gold-500 hover:bg-gold-400 text-dark-900 font-extrabold text-xs flex items-center justify-center gap-1.5 shadow-md transition-all duration-300"
                      >
                        <span>Live Demo</span>
                    ...
                    <button
                      ...
                      className={`${project.liveUrl ? 'flex-1' : 'w-full'} py-2.5 px-4 rounded-xl bg-dark-800 hover:bg-gold-500 text-gold-400 hover:text-dark-900 border border-gold-500/30 hover:border-gold-500 font-bold text-xs flex items-center justify-center gap-2 transition-all duration-300 group/btn`}
                    >
                      <span>Details</span>
