  ...
  return (
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 overflow-y-auto bg-black/85 backdrop-blur-md">
        ...
        >
          {/* Header Action Bar */}
          <div className="p-4 sm:p-6 bg-dark-900 border-b border-gray-800 flex flex-wrap sm:flex-nowrap items-center justify-between gap-3 shrink-0">
            <div className="flex items-center gap-2 min-w-0">
              <span className="w-2.5 h-2.5 rounded-full bg-emerald-500 animate-ping shrink-0" />
              <h2 className="text-xs sm:text-lg font-extrabold text-white truncate">
                Curriculum Vitae — Karan Gehlot
              </h2>
            </div>
            ...
            <div className="flex items-center gap-2 shrink-0">
              <button
                onClick={handlePrint}
                className="px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-xl bg-dark-800 border border-gray-700 hover:border-gold-500 text-gray-300 hover:text-gold-400 text-xs font-semibold flex items-center gap-1.5 transition-all"
                title="Print / Save as PDF"
              >
                <Printer className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-gold-400" />
                <span>Print / Save PDF</span>
              </button>

              <button
                onClick={onClose}
                className="p-1.5 sm:p-2 rounded-xl bg-dark-800 border border-gray-700 text-gray-400 hover:text-gold-400 hover:border-gold-500 transition-all"
                title="Close modal"
              >
